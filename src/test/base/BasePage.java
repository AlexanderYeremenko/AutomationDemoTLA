...
public class BasePage {
    //all pageclasses will extend this class
    //contains common webElements and common methods which can be used in pageclasses
    protected WebDriver driver;

    public BasePage(WebDriver driver){
        this.driver = driver;//this means the driver of this page
        PageFactory.initElements(driver, this);//Connects driver with all the objects inside this page
    }
